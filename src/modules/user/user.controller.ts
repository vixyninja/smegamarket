...
export class UserController {
  ...
  @Patch('password')
  async updatePassword(@UserDynamic('uuid') userUUID: string, @Body('password') password: string): Promise<any> {
    const user: UserEntity = await this.userService.updateUserPassword(userUUID, password);
